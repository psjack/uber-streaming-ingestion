# This program creates a streaming table: this streaming table has bulk rides and current rides data. For the current rides data (from event hub)
# ..., the data is converted from string to json using the schema string
